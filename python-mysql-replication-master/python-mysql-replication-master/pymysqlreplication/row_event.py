    ...
    def _dump(self):
        ...
        for row in self.rows:
            ...
            for key in row["before_values"]:
                ...
                if key=="id":
                    #update_st= update_st + '"' +  key + '": ' + str(row["after_values"][key]) + ','
                ...
                #    update_st= update_st + '"' +  key + '": ' + '"' + str(row["after_values"][key]) + '",'
                    ...
                    #update_st= update_st + '"' +  key + '": ' + '"' + row["after_values"][key] + '",'
        ...
        """solr.add([
            {
                ...
                "status": 1,
                #"lastupdate": "2015-12-15 10:05:52",
            },
            {
                "id": 13,
                "title": "A test document",
